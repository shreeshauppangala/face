...
const App = () => {
	...
	} else if (initialState.route === 'Signin') {
		component = <Signin loadUser={loadUser} onRouteChange={onRouteChange} />
	} else {
		component = <Signup loadUser={loadUser} onRouteChange={onRouteChange} />
	}
	return (
		<div className="App" >
			<Logo />
